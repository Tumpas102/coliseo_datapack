...
scoreboard players set @a runa_timer1 0
scoreboard players set @a runa_timer4 0
scoreboard players set @a runa_timer5 0
scoreboard players set @a runa_timer8 0
scoreboard players set @a runa_timer10 0
